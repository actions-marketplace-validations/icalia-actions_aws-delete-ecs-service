...
ARG APP_PATH=/icalia-actions/aws-delete-ecs-service
...
ARG APP_PATH=/icalia-actions/aws-delete-ecs-service
COPY --from=builder --chown=node:node ${APP_PATH} /icalia-actions/aws-delete-ecs-service
WORKDIR /icalia-actions/aws-delete-ecs-service
